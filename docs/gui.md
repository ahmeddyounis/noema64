...
- Settings for mode, personality, provider, API endpoint/key, cloud-provider acknowledgement, verifier path/timing, external tablebase probe, trace logging, raw logging flags, and log output directory.
